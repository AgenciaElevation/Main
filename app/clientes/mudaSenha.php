...
?>
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="#">Alterar Senha</a>

            <!-- Navbar Search-->
            <form class="d-none d-md-inline-block form-inline ms-auto me-0 me-md-3 my-2 my-md-0">
                <div class="input-group text-white">
                    Usuário: <?php echo $cliente; ?>
                </div>
            </form>
            <!-- Navbar-->
                        ...
                        <div class="col-md-4">
                            <div class="card bg-primary text-light text-center">
                                ...
                                <div class="card-body bg-light text-dark">
                                    ...
                                    require('../cliente.php');
                                    $cliente = new cliente();
                                    $consulta = $cliente->consultaID($dataId);
        ...
        <footer class="py-4 bg-dark" style="position: absolute; bottom: 0; width: 100%">
            <div class="container-fluid px-4">
                <div class="d-flex align-items-center justify-content-between small">
                    <div class="text-muted">Logado como: <?php echo $cliente; ?></div>
                </div>
            </div>
        </footer>
