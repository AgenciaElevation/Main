            ...
            <main>
                <div class="container px-4">
                    ...
                    foreach ($consulta as $linha) {
                        ...
                        $status = ($linha['finished'] == 1) ? "<span class='text-success'>FINALIZADO</span>" : "<span class='text-danger'>EM ABERTO</span>";
                        echo"
                        <div class='card mb-5'>
                            ...
                            <div class='row'>
                                ...
                                <div class='col'>
                                    ...
                                    placeholder='Sem feedback' disabled>".
                    ...
                    <div class='row resultados'>
                     <div class='col'>
                       Total de tíquetes: $total_tiquetes
                     </div>  
                     <div class='col'>
                         Tíquetes em aberto: $tiquetes_abertos
                     </div>
                     <div class='col'>
                     Tíquetes finalizados: $tiquetes_finalizados
                 </div>
                    </div>";
                
                    ?>
                <a href="tiquetes.php" class="btn btn-secondary px-4 mt-4 mb-5">VOLTAR</a>
        </div>
