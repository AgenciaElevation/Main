...
?>
    ...
    <body>
     ...
     <div class="container">
        ...
        <p>A sua privacidade é importante para nós. É política do Elevation Agência de Serviços Digitais respeitar a sua privacidade em relação a qualquer informação sua que possamos coletar no site <a href=https://www.agenciaelevation.com.br />Elevation Agência de Serviços Digitais</a>, e outros sites que possuímos e operamos.</p>
        ...
        <h2>Política de Cookies Elevation Agência de Serviços Digitais</h2>
        ...
        <p>O usuário se compromete a fazer uso adequado dos conteúdos e da informação que o Elevation Agência de Serviços Digitais oferece no site e com caráter enunciativo, mas não limitativo:</p>
        <ul>
            ...
            <li>C) Não causar danos aos sistemas físicos (hardwares) e lógicos (softwares) do Elevation Agência de Serviços Digitais, de seus fornecedores ou terceiros, para introduzir ou disseminar vírus informáticos ou quaisquer outros sistemas de hardware ou software que sejam capazes de causar danos anteriormente mencionados.</li>
        </ul>
        <h3>Mais informações</h3>
        <p>Esperemos que esteja esclarecido e, como mencionado anteriormente, se houver algo que você não tem certeza se precisa ou não, geralmente é mais seguro deixar os cookies ativados, caso interaja com um dos recursos que você usa em nosso site.</p>
        <p>Esta política é efetiva a partir de <strong>Jul</strong>/<strong>2023</strong>.</p>
    </div>
